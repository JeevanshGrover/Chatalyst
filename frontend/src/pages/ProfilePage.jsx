        ...
        <div className="bg-base-300 rounded-xl p-4 sm:p-6 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg border break-all">{authUser?.email}</p>
            </div>
          </div>
          ...
          <div className="mt-6 bg-base-300 rounded-xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex flex-col items-start gap-1 py-2 border-b border-zinc-700 sm:flex-row sm:items-center sm:justify-between">
